...
| `GeoGridJSONReaderTest::contatCentersTest` | `gengeopop::GeoGridJSONReader::ParseContactCenter` | Read a json file using the reader and check the GeoGrid with an expected GeoGrid, but only the contactcenters. |
