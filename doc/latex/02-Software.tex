...
If the version of \texttt{protobuf-c} you're using is significantly newer than the one included in this repository, you might also need to update the files stored \texttt{main/resources/lib/protobuf}.
