...
class GeoGrid_Location_Commute : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.GeoGrid.Location.Commute) */ {
 public:
  ...
  ::google::protobuf::int64 proportion() const;
  void set_proportion(::google::protobuf::int64 value);
 ...
 private:
  ...
  ::google::protobuf::int64 proportion_;
  friend struct ::protobuf_geogrid_2eproto::TableStruct;
...
inline void GeoGrid_Location_Commute::clear_proportion() {
  proportion_ = GOOGLE_LONGLONG(0);
  clear_has_proportion();
}
inline ::google::protobuf::int64 GeoGrid_Location_Commute::proportion() const {
  // @@protoc_insertion_point(field_get:proto.GeoGrid.Location.Commute.proportion)
  return proportion_;
}
inline void GeoGrid_Location_Commute::set_proportion(::google::protobuf::int64 value) {
  set_has_proportion();
  proportion_ = value;
