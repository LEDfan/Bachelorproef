...
void GeoGridConfig::Calculate(std::shared_ptr<GeoGrid> geoGrid, std::shared_ptr<HouseholdReader> householdReader)
{
        ...
        calculated._1865_and_years_active = calculated._1865_years - calculated._1826_years_and_student;
        calculated.fraction_1865_and_years_active =
            static_cast<double>(calculated._1865_and_years_active) / static_cast<double>(input.populationSize);
