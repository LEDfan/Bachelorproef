...
namespace {
        ...
        TEST(HighSchoolGeneratorTest, FiveLocationsTest) {
                ...
                HighSchoolGenerator schoolGenerator(rnManager);
                GeoGridConfig config;
                config.populationSize = 399992;
                config.fraction_1826Years_WhichAreStudents = 0.20;

                auto geoGrid = std::make_shared<GeoGrid>();
                std::vector<int> sizes {28559, 33319, 39323, 37755, 35050, 10060, 13468, 8384, 9033, 31426, 33860, 4110, 50412, 25098, 40135};
                for (int size : sizes) {
