...
TEST(WorkplaceGeneratorTest, TenCommuting)
{
        ...
        EXPECT_EQ(2951, geoGrid->get(0)->outGoingCommutingPeople(
                            config.fraction_CommutingPeople)); // = 0,23 * 128331 * 0,10 = 2951,613
        ...
        EXPECT_EQ(1591, geoGrid->get(10)->outGoingCommutingPeople(
                            config.fraction_CommutingPeople)); // = 0,25 * 63673 * 0,10 = 1591,825
        EXPECT_EQ(2951, geoGrid->get(10)->incomingCommutingPeople(
                            config.fraction_CommutingPeople)); // = 0,23 * 128331 * 0,10 = 2951,613
        EXPECT_EQ(5029, geoGrid->get(25)->outGoingCommutingPeople(
                            config.fraction_CommutingPeople)); // = 0,43 * 116959 * 0,10 = 5029,023
        ...
        EXPECT_EQ(10680, geoGrid->get(17)->incomingCommutingPeople(config.fraction_CommutingPeople)); // = 0,10 * (0,65
                                                                                                      // * 76946 + 0,22
                                                                                                      // * 141389 + 0,47
                                                                                                      // * 20775 + 0,25*
                                                                                                      // 63673) =
        ...
        EXPECT_EQ(5001, geoGrid->get(38)->outGoingCommutingPeople(
                            config.fraction_CommutingPeople)); // = 0,65 * 76946 * 0,10 = 5001,048
        ...
        EXPECT_EQ(3110, geoGrid->get(15)->outGoingCommutingPeople(
                            config.fraction_CommutingPeople)); // 0,22 * 141389 * 0,10 = 3310,558
