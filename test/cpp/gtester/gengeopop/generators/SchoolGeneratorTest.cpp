...
namespace {
        ...
        TEST(SchoolGeneratorTest, OneLocationTest) {
            ...
            auto loc1 = std::make_shared<Location>(1, 4, 2500, 0, 0, 0, 0, "Antwerpen");
        ...
        TEST(SchoolGeneratorTest, FiveLocationsTest) {
                ...
                auto geoGrid = std::make_shared<GeoGrid>();
                auto loc1 = std::make_shared<Location>(1, 4, 10150*100, 0, 0, 0, 0, "Antwerpen");
                auto loc2 = std::make_shared<Location>(1, 4, 10040*100, 0, 0, 0, 0, "Vlaams-Brabant");
                auto loc3 = std::make_shared<Location>(1, 4, 7460*100, 0, 0, 0, 0, "Henegouwen");
                auto loc4 = std::make_shared<Location>(1, 4, 3269*100, 0, 0, 0, 0, "Limburg");
                auto loc5 = std::make_shared<Location>(1, 4, 4123*100, 0, 0, 0, 0, "Luxemburg");
