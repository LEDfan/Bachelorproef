...
std::shared_ptr<GeoGrid> getExpectedGeoGrid() {
        ...
        geoGrid->addLocation(std::make_shared<Location>(11002, 1, 269954, Coordinate(153104.586,  212271.7101, 51.2165845,  4.413545489), "ANTWERPEN"));
        geoGrid->addLocation(std::make_shared<Location>(11007, 1, 6643,   Coordinate(158373.2671, 209240.2514, 51.1966684,  4.4856299),   "BORSBEEK"));
        geoGrid->addLocation(std::make_shared<Location>(11008, 1, 23237,  Coordinate(158918.8198, 221748.3274, 51.29227,    4.49419),     "BRASSCHAAT"));
        geoGrid->addLocation(std::make_shared<Location>(11009, 1, 16227,  Coordinate(168070.1501, 224780.0715, 51.3495775,  4.6376322),   "BRECHT"));
        geoGrid->addLocation(std::make_shared<Location>(11016, 1, 10454,  Coordinate(156460.2596, 237847.8004, 51.38298,    4.47518),     "ESSEN"));
        geoGrid->addLocation(std::make_shared<Location>(73107, 7, 23326,  Coordinate(243578.1573, 184975.9303, 50.96991794, 5.70979219),  "MAASMECHELEN"));
        geoGrid->addLocation(std::make_shared<Location>(73109, 7, 2583,   Coordinate(251986.4171, 160699.7771, 50.74921941, 5.806343076), "VOEREN-'S GRAVENVOEREN"));
        return geoGrid;
}
